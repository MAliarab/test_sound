...
برای استفاده از مدل باید مدل اموزش دیده را در فولدر Trained-Model کپی کنید و با استفاده از نمونه کد زیر میتوان از مدل برای شناسایی پهپاد در تصاویر استفاده کرد
